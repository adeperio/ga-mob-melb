...
class ArrayTableViewController: UITableViewController {
    ...
    */
    let animalArray = [AnimalInformation(name: "Rover", desc: "dog"), AnimalInformation(name: "Mittens", desc: "rabbit"), AnimalInformation(name: "Ein", desc: "cat"), AnimalInformation(name: "Sadie", desc: "pidgeon")]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = animalArray[indexPath.row].prettyAnimalDesc()
        return cell
    }
}
