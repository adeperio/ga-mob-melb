...
class ToDoListTableViewController: UITableViewController, ViewControllerDelegate {
    ...
    @IBAction func addToDo(sender: AnyObject) {
        ...
        let addVCInstance = self.storyboard?.instantiateViewControllerWithIdentifier("addVC")
        
        self.presentViewController(addVCInstance!, animated: true, completion: nil)
        
        if let viewController = addVCInstance as? ViewController {
