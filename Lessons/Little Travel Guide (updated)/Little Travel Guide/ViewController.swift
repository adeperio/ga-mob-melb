...
class ViewController: UIViewController {    
    ...
    @IBAction func Info(sender: AnyObject) {
        let essentialInfoVC = self.storyboard?.instantiateViewControllerWithIdentifier("essentialInfo")
        
        self.presentViewController(essentialInfoVC!, animated: true, completion: nil)
