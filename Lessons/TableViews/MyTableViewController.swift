...
//        let arrayIndex = indexPath.row //0
//        
...
//         cell.textLabel!.text = myCity
        ...
        //this tells the app to show the row as the user scrolls.
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        //gives a reference to the tableview and index path.  can use this if the row is selected can take you to a new path or view controller.
